...
from ddss.orm import initialize_database, Facts
from ddss.chain import main
...
@pytest.mark.asyncio
async def test_chain_simple_modus_ponens(temp_db):
...
@pytest.mark.asyncio
async def test_chain_multi_premise(temp_db):
    """Test multi-premise rule: 'a, b => c'"""
    addr, engine, session = temp_db
...
@pytest.mark.asyncio
async def test_chain_no_inference_without_matching_facts(temp_db):
...
@pytest.mark.asyncio
async def test_chain_multiple_inferences(temp_db):
...
@pytest.mark.asyncio
async def test_chain_cancellation(temp_db):
    """Test that the chain main function can be cancelled without hanging."""
    addr, engine, session = temp_db
...
@pytest.mark.asyncio
async def test_chain_duplicate_facts_not_added(temp_db):
